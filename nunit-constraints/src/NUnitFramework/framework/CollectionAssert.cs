...
namespace NUnit.Constraints
{
	...
	public class CollectionAssert
	{
		...
		{
            Verify.That(collection, new AllItemsConstraint(new InstanceOfTypeConstraint(expectedType)), message, args);
		}
		#endregion
		...
		{
            Verify.That(collection, new AllItemsConstraint(new NotConstraint(new EqualConstraint(null))), message, args);
		}
		#endregion
		...
		{
            Verify.That(collection, new UniqueItemsConstraint(), message, args);
		}
		#endregion
		...
		public static void AreEqual (IEnumerable expected, IEnumerable actual) 
		{
            ...
            Verify.That(actual, new EqualConstraint(expected));
		}
		...
		public static void AreEqual (IEnumerable expected, IEnumerable actual, string message) 
		{
            ...
            Verify.That(actual, new EqualConstraint(expected), message);
		}
		...
		public static void AreEqual (IEnumerable expected, IEnumerable actual, string message, params object[] args) 
		{
            ...
            Verify.That(actual, new EqualConstraint(expected), message, args);
		}
		...
		{
            Verify.That(actual, new EqualConstraint(expected).Using(comparer), message, args);
		}
		#endregion
		...
		{
            Verify.That(actual, new CollectionEquivalentConstraint(expected), message, args);
		}
		#endregion
		...
		{
            Verify.That(actual, new NotConstraint(new EqualConstraint(expected)));
		}
		...
		{
            Verify.That(actual, new NotConstraint(new EqualConstraint(expected)), message);
		}
		...
		public static void AreNotEqual (IEnumerable expected, IEnumerable actual, string message, params object[] args) 
		{
            ...
            Verify.That(actual, new NotConstraint(new EqualConstraint(expected)), message, args);
		}
		...
		{
			Verify.That(actual, new NotConstraint(new EqualConstraint(expected).Using(comparer)), message, args);
		}
		#endregion
		...
		{
            Verify.That(actual, new NotConstraint(new CollectionEquivalentConstraint(expected)), message, args);
		}
		#endregion
		...
		{
            Verify.That(collection, new CollectionContainsConstraint(actual), message, args);
		}
		#endregion
		...
		{
            Verify.That(collection, new NotConstraint( new CollectionContainsConstraint( actual ) ), message, args);
		}
		#endregion
		...
		{
            Verify.That(subset, new NotConstraint(new CollectionSubsetConstraint(superset)), message, args);
		}
		#endregion
		...
		{
            Verify.That(subset, new CollectionSubsetConstraint(superset), message, args);
		}
		#endregion
        ...
        {
            Verify.That(collection, new EmptyConstraint(), message, args);
        }
        ...
        {
            Verify.That(collection, new NotConstraint(new EmptyConstraint()), message, args);
        }
        ...
        {
            Verify.That(collection, new CollectionOrderedConstraint(), message, args);
        }
        ...
        {
            Verify.That(collection, new CollectionOrderedConstraint().Using(comparer), message, args);
        }
