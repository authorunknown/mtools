...
namespace NUnit.Constraints
{
    ...
    public class DirectoryAssert
    {
        ...
        {
            Verify.That( directory, new EmptyDirectoryContraint(), message, args);
        }
        ...
        {
            Verify.That( directory, new NotConstraint(new EmptyDirectoryContraint()), message, args);
        }
        ...
        {
            Verify.That(actual, new SubDirectoryConstraint(directory), message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new SubDirectoryConstraint(directory) ), message, args );
        }
