...
namespace NUnit.Constraints
{
	...
	public class StringAssert
	{
        ...
        {
            Verify.That(actual, new SubstringConstraint(expected), message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new SubstringConstraint(expected) ), message, args );
        }
        ...
        {
            Verify.That(actual, new StartsWithConstraint(expected), message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new StartsWithConstraint(expected) ), message, args);
        }
        ...
        {
            Verify.That(actual, new EndsWithConstraint(expected), message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new EndsWithConstraint(expected) ), message, args);
        }
        ...
        {
            Verify.That(actual, new EqualConstraint(expected).IgnoreCase, message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new EqualConstraint(expected).IgnoreCase ), message, args);
        }
        ...
        {
            Verify.That(actual, new RegexConstraint(pattern), message, args);
        }
        ...
        {
            Verify.That(actual, new NotConstraint( new RegexConstraint(pattern) ), message, args);
        }
